...
int bitree_ins_right(BiTree *tree, BiTreeNode *node, const void *data) {
    ...
    *position = new_node;
    ...
    /* Adjust the size of the tree to account fot the inserted node. */
    tree->size++;
...
void bitree_rem_right(BiTree *tree, BiTreeNode *node) {
    ...
    /* Adjust the size of the tree to account for the removed mode. */
    tree->size--;
}
...
int bitree_merge(BiTree *merge, BiTree *left, BiTree *right, const void *data) {
    ...
    /* Do not let the original trees assess the merged nodes. */
    left->root = NULL;
    left->size = 0;
    right->root = NULL;
    right->size = 0;
